export default function About() {
  return (
    <section id="about">
      <h2>About Me</h2>
      <p>
        I am currently working at a position of Associate Software Engineer at Credex Technology, Noida. Java is a key
      ...
      <div className="about-cards">
        ...
        <div className="card">
          ...
          <p>
            ...
            growing in Python, algorithms, data structures, and system design. Building a Chess-960 first website.
          </p>
        </div>
        <div className="card">
          <h3>Goals</h3>
